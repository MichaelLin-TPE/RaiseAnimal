...
public class ColorViewHolder extends RecyclerView.ViewHolder {
    ...
    public ColorViewHolder(@NonNull View itemView,Context context) {
        super(itemView);
        ...
        tvTitle.setText(context.getString(R.string.color));
    }

    public void setData(ArrayList<String> colorArray) {
        final FilterItemAdapter adapter = new FilterItemAdapter(colorArray,context);
