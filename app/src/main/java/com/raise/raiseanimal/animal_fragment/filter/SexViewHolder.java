...
public class SexViewHolder extends RecyclerView.ViewHolder {
    ...
    public SexViewHolder(@NonNull View itemView, Context context) {
        super(itemView);
        ...
        tvTitle.setText(context.getString(R.string.sex));
    }

    public void setData(ArrayList<String> sexArray) {
        final FilterItemAdapter adapter = new FilterItemAdapter(sexArray,context);
