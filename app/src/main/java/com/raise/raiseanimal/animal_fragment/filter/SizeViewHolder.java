...
public class SizeViewHolder extends RecyclerView.ViewHolder{
    ...
    public SizeViewHolder(@NonNull View itemView, Context context) {
        super(itemView);
        ...
        tvTitle.setText(context.getString(R.string.size));
    }

    public void setData(ArrayList<String> sizeArray) {
        final FilterItemAdapter adapter = new FilterItemAdapter(sizeArray,context);
